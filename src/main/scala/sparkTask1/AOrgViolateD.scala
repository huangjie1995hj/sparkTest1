...
object AOrgViolateD {
  ...
  def AOrgViolateD(hc:HiveContext,dataDate:String): Boolean ={
   ...
   /* def getColumn(column:String): String ={
    ...
    val frame = data1.groupBy($"ORG_NO",$"ORG_TYPE",$"ORG_NAME",$"STAT_TIME").agg(
      ...
      sum($"A00112_DURING") as "A00112_DURING",
      sum("A00112_CNT") as "A00112_CNT" ,
      sum($"A00100_DURING") as "A00100_DURING",
      sum("A00100_CNT") as "A00100_CNT" ,
      sum($"A0010J_DURING") as "A0010J_DURING",
      sum("A0010J_CNT") as "A0010J_CNT" ,
      sum($"A00102_DURING") as "A00102_DURING",
      sum("A00102_CNT") as "A00102_CNT" ,
      sum($"A00113_DURING") as "A00113_DURING",
      sum("A00113_CNT") as "A00113_CNT" ,
      sum($"A00114_DURING") as "A00114_DURING",
      sum("A00114_CNT") as "A00114_CNT" ,
      sum($"A00115_DURING") as "A00115_DURING",
      sum("A00115_CNT") as "A00115_CNT" ,
      sum($"A00116_DURING") as "A00116_DURING",
      sum("A00116_CNT") as "A00116_CNT" ,
      sum($"A00118_DURING") as "A00118_DURING",
      sum("A00118_CNT") as "A00118_CNT" ,
      sum($"A00119_DURING") as "A00119_DURING",
      sum("A00119_CNT") as "A00119_CNT" ,
      sum($"A0011B_DURING") as "A0011B_DURING",
      sum("A0011B_CNT") as "A0011B_CNT" ,
      sum($"A0011E_DURING") as "A0011E_DURING",
      sum("A0011E_CNT") as "A0011E_CNT" ,
      sum($"A0011J_DURING") as "A0011J_DURING",
      sum("A0011J_CNT") as "A0011J_CNT",

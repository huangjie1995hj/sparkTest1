...
object Submit3 {
  def main(args: Array[String]): Unit = {
    ...
    val dataFrame = context1.read
      ...
      .load(s"""/temp/a_cons_violate_m201911.csv""")
    ...
    val df = dataFrame.select(
      ...
      $"A00112_DAY_CNT".cast("decimal(26, 0)"),
      $"A00100".cast("String"),
      $"A00100_DURING".cast("decimal(16, 2)"),
      $"A00100_DAY_CNT".cast("decimal(26, 0)"),
      $"A0010J".cast("String"),
      $"A0010J_DURING".cast("decimal(16, 2)"),
      $"A0010J_DAY_CNT".cast("decimal(26, 0)"),
      $"A00102".cast("String"),
      $"A00102_DURING".cast("decimal(16, 2)"),
      $"A00102_DAY_CNT".cast("decimal(26, 0)"),
      $"A00113".cast("String"),
      $"A00113_DURING".cast("decimal(16, 2)"),
      $"A00113_DAY_CNT".cast("decimal(26, 0)"),
      $"A00114".cast("String"),
      $"A00114_DURING".cast("decimal(16, 2)"),
      $"A00114_DAY_CNT".cast("decimal(26, 0)"),
      $"A00115".cast("String"),
      $"A00115_DURING".cast("decimal(16, 2)"),
      $"A00115_DAY_CNT".cast("decimal(26, 0)"),
      $"A00116".cast("String"),
      $"A00116_DURING".cast("decimal(16, 2)"),
      $"A00116_DAY_CNT".cast("decimal(26, 0)"),
      $"A00118".cast("String"),
      $"A00118_DURING".cast("decimal(16, 2)"),
      $"A00118_DAY_CNT".cast("decimal(26, 0)"),
      $"A00119".cast("String"),
      $"A00119_DURING".cast("decimal(16, 2)"),
      $"A00119_DAY_CNT".cast("decimal(26, 0)"),
      $"A0011B".cast("String"),
      $"A0011B_DURING".cast("decimal(16, 2)"),
      $"A0011B_DAY_CNT".cast("decimal(26, 0)"),
      $"A0011E".cast("String"),
      $"A0011E_DURING".cast("decimal(16, 2)"),
      $"A0011E_DAY_CNT".cast("decimal(26, 0)"),
      $"A0011J".cast("String"),
      $"A0011J_DURING".cast("decimal(16, 2)"),
      $"A0011J_DAY_CNT".cast("decimal(26, 0)"),
      ...
      $"ANTISTEALINGPRO".cast("decimal(22,8)")
    )
    df.printSchema()
    ...
    //kudu.in(df, "A_CONS_VIOLATE_D")
    kudu.insert11("A_CONS_VIOLATE_M",df,"201912")
    true
    print(">>>>>>>>>>>>>>>>>>末尾")
  }
